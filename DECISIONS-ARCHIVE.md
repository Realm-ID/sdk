# Decision Log — Realm ID SDK monorepo — Archive

Older entries moved out of `DECISIONS.md` on 2026-08-25 to keep that file
navigable (skill: `decision-log`). **Text is moved verbatim, never reworded.**
See `DECISIONS.md`'s `## Index` for the full chronological list across both
files — this file holds everything before 2026-07-27.

Newest first (continues from where `DECISIONS.md` leaves off).
